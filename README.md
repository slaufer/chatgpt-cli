...
Options:
  ...
  By default, the program begins in interactive mode. Interactive mode uses a multi-line editor. Press Alt+Enter to submit; Ctrl+B (or enter /menu) to show the menu; Ctrl+C or Ctrl+D to exit.
